...
3. Download all files in the specified repository onto your computer.  On the main page of the repository, click the button to clone or download and download the zip folder onto your harddrive (don't forget to unzip the folder), or use git commands if you are familiar with them.
